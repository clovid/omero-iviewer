...
export const VIEWER_REMOVE_INTERACTION_OR_CONTROL = "VIEWER_REMOVE_INTERACTION_OR_CONTROL";
export const VIEWER_SET_SHAPE_POPUP_VISIBILITY = "VIEWER_SET_SHAPE_POPUP_VISIBILITY";
export const VIEWER_SET_REGIONS_MODES = "VIEWER_SET_REGIONS_MODES";
export const VIEWER_INITIALIZED = "VIEWER_INITIALIZED";
export const VIEWER_SELECT_SHAPES = "VIEWER_SELECT_SHAPES";
export const VIEWER_SET_TEXT_BEHAVIOR = "VIEWER_SET_TEXT_BEHAVIOR";
export const VIEWER_SET_SHAPE_TOOLTIP_VISIBILITY = "VIEWER_SET_SHAPE_TOOLTIP_VISIBILITY";
